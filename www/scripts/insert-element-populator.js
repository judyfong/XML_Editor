...
(function(mod) {
  ...
  function ElementPlacer(cm, options) {
    this.cm = cm;
  ...
  function getText(element_finder) {
    if (typeof element_finder == "string") return element_finder;
    else return element_finder.text;
  }
